...
var ASM_CONSTS = {
  4287708: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4287763: ($0) => { performance.now = function() { return $0; }; },  
 4287811: ($0) => { performance.now = function() { return $0; }; },  
 4287859: () => { performance.now = Module['emscripten_get_now_backup']; }
};
